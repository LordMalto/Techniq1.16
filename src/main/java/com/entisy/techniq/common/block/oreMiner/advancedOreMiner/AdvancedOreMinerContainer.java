...
public class AdvancedOreMinerContainer extends Container {

    public final AdvancedOreMinerTileEntity tileEntity;
    private final IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder currentSmeltTime;
    public FunctionalIntReferenceHolder currentEnergy;

    public AdvancedOreMinerContainer(final int id, final PlayerInventory inv, final AdvancedOreMinerTileEntity tileEntity) {
        super(ModContainerTypes.ADVANCED_ORE_MINER_CONTAINER_TYPE.get(), id);
    ...
    public AdvancedOreMinerContainer(final int id, final PlayerInventory inv, final PacketBuffer buffer) {
        this(id, inv, getTileEntity(inv, buffer));
    }

    private static AdvancedOreMinerTileEntity getTileEntity(PlayerInventory inv, PacketBuffer buffer) {
        ...
        if (tileEntity instanceof AdvancedOreMinerTileEntity) {
            return (AdvancedOreMinerTileEntity) tileEntity;
        }
    ...
    public boolean stillValid(PlayerEntity player) {
        return stillValid(canInteractWithCallable, player, ModBlocks.ADVANCED_ORE_MINER.get());
    }
