...
public class SimpleOreMinerContainer extends Container {

    public final SimpleOreMinerTileEntity tileEntity;
    private final IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder currentSmeltTime;
    public FunctionalIntReferenceHolder currentEnergy;

    public SimpleOreMinerContainer(final int id, final PlayerInventory inv, final SimpleOreMinerTileEntity tileEntity) {
        super(ModContainerTypes.SIMPLE_ORE_MINER_CONTAINER_TYPE.get(), id);
        ...
        // furnace
        addSlot(new OutputSlot(tileEntity.getInventory(), 0, 74, 35));
        addSlot(new OutputSlot(tileEntity.getInventory(), 1, 92, 35));
    ...
    public SimpleOreMinerContainer(final int id, final PlayerInventory inv, final PacketBuffer buffer) {
        this(id, inv, getTileEntity(inv, buffer));
    }

    private static SimpleOreMinerTileEntity getTileEntity(PlayerInventory inv, PacketBuffer buffer) {
        ...
        if (tileEntity instanceof SimpleOreMinerTileEntity) {
            return (SimpleOreMinerTileEntity) tileEntity;
        }
    ...
    public boolean stillValid(PlayerEntity player) {
        return stillValid(canInteractWithCallable, player, ModBlocks.SIMPLE_ORE_MINER.get());
    }
